...
% Ajout Cyril :
\usepackage[linktocpage=true,linkcolor=cyan,citecolor=black,colorlinks=true,urlcolor=blue,pagebackref]{hyperref}
...
\Titre{ÉVALUATION DES EFFETS CUMULATIFS SUR LES COMMUNAUTÉS ÉCOLOGIQUES}
