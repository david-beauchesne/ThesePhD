...
\caption{Comparison of the network-scale and species-scale cumulative effects assessments for a) groundfish species (\textit{i.e.} Atlantic halibut \textit{Hippoglossus hippoglossus}; American plaice \textit{Hippoglossoides platessoides}; witch flounder \textit{Glyptocephalus cynoglossus}; Atlantic cod \textit{Gadus morhua}; redfish \textit{Sebastes spp.}; Greenland halibut \textit{Reinhardtius hippoglossoides}), b) monkfish (\textit{Lophius americanus}) and c) beluga whales (\textit{Delphinapterus leucas}).}
\label{ch5-species}
\end{figure}
